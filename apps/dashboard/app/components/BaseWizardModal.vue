    ...
    <Transition name="drawer-fade">
      <div v-if="modelValue" class="fixed inset-0 z-50">
        ...
        <Transition name="drawer-slide">
          <aside
            v-if="modelValue"
            class="absolute inset-0 h-full w-full bg-white shadow-2xl lg:inset-y-0 lg:right-0 lg:left-auto lg:w-[720px]"
          >
            <div class="flex h-full flex-col">
              ...
              <!-- Footer -->
              <div class="flex items-center justify-between border-t border-gray-200 px-5 py-4 lg:px-6">
                <button
                  v-if="currentStep > 0"
                  type="button"
